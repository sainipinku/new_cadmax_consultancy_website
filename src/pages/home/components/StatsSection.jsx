      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="space-y-8 lg:col-span-2">
            <div>
              <h2 className="font-clash text-section text-[var(--foreground)] mb-4">
                Numbers That
                <br />
            ...
            <p className="text-[var(--muted-foreground)] font-inter text-lg leading-relaxed">
          ...
          <div className="relative lg:h-[650px] h-[600px] w-full lg:col-span-3">
